  ...
  return (
    <section className="mt-9 border-t border-line pt-7">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <Field label={t('admin.consultations.governance.opens')} htmlFor="opensAtUtc"><CalendarInput id="opensAtUtc" type="datetime-local" className={inputClasses} value={toDateTimeInput(value.opensAtUtc)} onChange={event => onChange('opensAtUtc', event.target.value || undefined)} /></Field>
        <Field label={t('admin.consultations.governance.closes')} htmlFor="closesAtUtc"><CalendarInput id="closesAtUtc" type="datetime-local" className={inputClasses} value={toDateTimeInput(value.closesAtUtc)} onChange={event => onChange('closesAtUtc', event.target.value || undefined)} /></Field>
        <Field label={t('admin.consultations.governance.commentCloses')} htmlFor="commentClosesAtUtc"><CalendarInput id="commentClosesAtUtc" type="datetime-local" className={inputClasses} value={toDateTimeInput(value.commentClosesAtUtc)} onChange={event => onChange('commentClosesAtUtc', event.target.value || undefined)} /></Field>
