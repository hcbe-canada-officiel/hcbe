...
export const serviceCasesApi = {
  ...
  adminUpdate: (id: string, data: { category?: string; status?: string; priority?: string; assignedToUserId?: string; clearAssignee?: boolean; internalNotes?: string; assignedAssociationId?: string; clearAssociation?: boolean }) => apiClient.patch<ServiceCase>(`/api/admin/service-cases/${id}`, data),
